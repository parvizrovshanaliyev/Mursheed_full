    ...
    public partial class initDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Person",
                columns: new[] { "Id", "CountryId", "DateOfBirth", "Email", "FatherName", "Firstname", "Lastname" },
                values: new object[] { 1, null, new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "samir@code.edu.az", "Karimov", "Samir", "Karimov" });

    ...
    public partial class initDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransporterRoute", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransporterRoute_Route_RouteId",
                        column: x => x.RouteId,
                        principalTable: "Route",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransporterRoute_Transporter_TransporterId",
                        column: x => x.TransporterId,
                        principalTable: "Transporter",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Baki-Sumqayit d1", 50f, 2 },
                    { 9, 1, "Baki-Sumqayit d2", 55f, 2 },
                    { 2, 1, "Baki-Gence d1", 55f, 3 },
                    { 10, 1, "Baki-Gence d2", 45f, 3 },
                    { 3, 1, "Baki-Quba d1", 65f, 4 },
                    { 11, 1, "Baki-Quba d2", 50f, 4 },
                    { 4, 1, "Baki-Qusar d1", 45f, 5 },
                    { 12, 1, "Baki-Qusar d2", 55f, 5 },
                    { 5, 1, "Baki-Seki d1", 35f, 6 },
                    { 6, 2, "Sumqayit-Xacmaz d1", 25f, 7 },
                    { 7, 2, "Sumqayit-Mingecevir d1", 65f, 8 },
                    { 8, 2, "Sumqayit-Lenkeran d1", 50f, 9 }
                });

            migrationBuilder.InsertData(
                table: "Transporter",
                columns: new[] { "Id", "CarId", "CountryId", "CustomId", "DriverLicense", "FatherName", "Firstname", "GovernmentalId", "Lastname", "Photo", "Status" },
                values: new object[] { 1, 1, 1, null, null, "Rovshan", "Parviz", 123456789, "Ali", null, false });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransporterRoute_RouteId",
                table: "TransporterRoute",
                column: "RouteId");

            migrationBuilder.CreateIndex(
                name: "IX_TransporterRoute_TransporterId",
                table: "TransporterRoute",
                column: "TransporterId");
        }
